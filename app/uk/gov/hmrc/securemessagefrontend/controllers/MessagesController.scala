...
@Singleton
class MessagesController @Inject()(controllerComponents: MessagesControllerComponents,
                                  messageContent: messageContent,
                                   message: message
                                  )(implicit ec: ExecutionContext, appConfig: AppConfig) extends FrontendController(controllerComponents) with I18nSupport{

  def display(id: String) =  Action{ implicit request =>
